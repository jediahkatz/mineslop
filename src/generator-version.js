...
// closed; explicit v7 support must never silently migrate an older saved world.
export const SUPPORTED_GENERATOR_VERSIONS = Object.freeze([1, 2, 3, 4, 5, 6, 7]);
export const isSupportedGeneratorVersion = (version) =>
  SUPPORTED_GENERATOR_VERSIONS.includes(version);
export const hasExpandedTerrain = (version) =>

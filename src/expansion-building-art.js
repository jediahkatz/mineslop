...
const CLEAR = [0, 0, 0, 0];
const SLATE = ["#303037", "#3f3f45", "#535357", "#656567", "#78787b"];
const SLATE_END = ["#3e3e43", "#4c4c51", "#59595c", "#666668", "#747477"];
...
function paintDeepslate(p, face) {
  // Original fractured plates with interrupted horizontal and vertical edges.
  // Unequal plate widths/heights avoid a repeated diagonal ramp; the end uses
  // smaller interlocking grains. Side/end palettes and tonal totals stay fixed.
